...
import 'package:image_picker/image_picker.dart';
 ...
 // 👇 ADD THIS IMPORT (change project name if needed)
...
class GeminiService {
  ...
  GeminiService() {
    ...
    if (kDebugMode) {
      debugPrint(
          '[GeminiService] API Key configured: $_hasApiKey (length: ${_apiKey.length})');
    }
  ...
  Future<String> _sendImageMessage(
